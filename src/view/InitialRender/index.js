...
import DOMTree from '../UI/DOMTree';
...
export default function InitialRender(props){
  ...
  if(stage == 'render'){
    ...
    activeNode = node;
    if(type === 'firstChild'){
      summary = (<span>Create relation<ul>
        <li>Among <strong>rendered elements</strong>:
          <ul>
            <li>FirstChild --> sibling --> sibling ....</li>
          </ul>
        </li>
        <li>Among <strong>rendered elements and Parent</strong>:
            <ul>
              <li>FirstChild --> parent</li>
              <li>sibling --> parent</li>
              <li>sibling --> parent</li>
              <li>...</li>
          </ul>
        </li>
